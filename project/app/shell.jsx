/* ============================================================
   Cora — shell: marca, navegación lateral, barra inferior, gate
   ============================================================ */

/* ---------- logotipo (marca de palabra + corazón/latido) ---------- */
function CoraMark({ size = 26, color = 'var(--forest)' }) {
  return (
...
function Sidebar({ route, go, member, validador, setValidador, onLogout }) {
  return (
    <aside style={{
...
function BottomBar({ route, go, validador }) {
...
/* ---------- encabezado móvil ---------- */
function MobileHeader({ member, onLogout }) {
  return (
    <header style={{
...
Object.assign(window, { CoraMark, Sidebar, BottomBar, MobileHeader, NAV });
